...
fn load_spec(
	...
	match id {
		...
		"starkspc1" => Ok(Box::new(chain_spec::starks_pc1_testnet(para_id))),
...
impl SubstrateCli for Cli {
	fn impl_name() -> String {
		"zCloak Network Parachain Collator".into()
	}
	...
	fn description() -> String {
		format!(
			"zCloak test parachain collator\n\nThe command-line arguments provided first will be \
	...
	fn support_url() -> String {
		"https://github.com/zCloak-Network/zcloak-collator/issues/new".into()
	}
